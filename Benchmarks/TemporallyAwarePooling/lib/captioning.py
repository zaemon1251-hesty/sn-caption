...
from dataset import PredictionCaptions, SoccerNetCaptions, collate_fn_padd
from model import Video2Caption
from train import test_captioning, trainer, validate_captioning
from util import valid_probability
...
def main(args):
    ...
    checkpoint_path = os.path.join(
        "models", args.model_name, "caption", "model.pth.tar"
    )
...
def dvc(args):
    ...
    # this dataset does not need. just for getting corpus size!
    dataset_Test = SoccerNetCaptions(
        path=args.SoccerNet_path,
        features=args.features,
        split=args.split_test,

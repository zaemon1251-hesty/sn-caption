...
logging.add("logs/sample.log", format="{time} {level} {message}", level="INFO", rotation="10 MB")
from datetime import datetime

os.environ['OPENAI_API_KEY'] = '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'
...
if __name__ == "__main__":
    ...
    dataset_Test  = SoccerNetCaptions(path=root, features="baidu_soccer_embeddings.npy", split=["test"], version=2, framerate=framerate, window_size=window_size)
